    ...
    return (
        <main className="min-h-screen pt-24 pb-12 bg-gray-50">
            <div className="max-w-4xl mx-auto px-6">
                <div className="bg-white shadow-xl p-8 md:p-12 rounded-sm border-t-4 border-gold">
                    ...
                    <form action="https://formspree.io/f/ton_form_id" method="POST" className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-6 pt-1">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" name="Societe" value="Oui" className="text-gold focus:ring-gold" />
                                    <span className="text-gray-600">Oui</span>
                                </label>
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" name="Societe" value="Non" defaultChecked className="text-gold focus:ring-gold" />
                        ...
                        <button
                            type="submit"
                            className="w-full bg-black text-white py-4 uppercase tracking-widest text-sm font-bold hover:bg-gold transition-colors duration-300 mt-8"
                        >
                            Envoyer la demande
                        </button>
                    </form>
