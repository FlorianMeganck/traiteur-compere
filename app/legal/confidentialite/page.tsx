                ...
                <div className="space-y-8 text-gray-700 leading-relaxed font-light">
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            Pour toute question : <a href="mailto:contact@traiteur-compere.be" className="text-[#D4AF37] hover:underline">contact@traiteur-compere.be</a> <br />
                    ...
                    <section>
                        ...
                        <p>
                            Vous disposez d&apos;un droit d&apos;accès, de rectification, d&apos;effacement (« droit à l&apos;oubli ») et de portabilité de vos données. Pour exercer ce droit, envoyez simplement un e-mail à <a href="mailto:contact@traiteur-compere.be" className="text-[#D4AF37] hover:underline">contact@traiteur-compere.be</a>.
                        </p>
                    </section>
